...
def log(
    ...
    # imported lazily: `app.settings` imports `app.settings_utils`, which
    # imports this module for `log`/`Ansi`. Importing settings at module
    # scope here would close that cycle and break whichever module the
    # interpreter happens to load first.
